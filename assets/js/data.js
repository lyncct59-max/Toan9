...
(function (App) {
  ...
  /* ===================== 🎓 ĐỀ THI THỬ VÀO 10 (90 phút · thang 10) ===================== */
  const EXAMS = [
    { id: "de-1", name: "Đề số 1", desc: "Cấu trúc chuẩn: căn thức → hệ PT & vòi nước → Vi-ét → hình đường cao → GTNN",
      questions: [
        { cau: "Câu 1a", points: 1, type: "mc", q: "Rút gọn A = √50 − √18 + √8.",
          options: ["A = 4√2", "A = 2√2", "A = 6√2", "A = 4√10"], answer: 0,
          sol: ["√50 = 5√2; √18 = 3√2; √8 = 2√2", "A = 5√2 − 3√2 + 2√2 = 4√2"] },
        { cau: "Câu 1b", points: 1, type: "fill", q: "Tính B = (√5 + 1)² − 2√5. B = ?", answer: "6", accept: ["6"],
          sol: ["(√5 + 1)² = 5 + 2√5 + 1 = 6 + 2√5", "B = 6 + 2√5 − 2√5 = 6"] },
        { cau: "Câu 2a", points: 1, type: "fill", q: "Giải hệ: 2x + y = 7 và x − y = 2. Giá trị x = ?", answer: "3", accept: ["3", "x=3"],
          sol: ["Cộng hai phương trình: 3x = 9 → x = 3", "Thay vào x − y = 2 → y = 1"] },
        { cau: "Câu 2b", points: 0.5, type: "fill", q: "Với hệ ở Câu 2a, giá trị y = ?", answer: "1", accept: ["1", "y=1"],
          sol: ["x = 3 → 3 − y = 2 → y = 1", "Thử lại: 2·3 + 1 = 7 ✓"] },
        { cau: "Câu 2c", points: 0.5, type: "mc", q: "Hai vòi cùng chảy đầy bể trong 6 giờ. Vòi II một mình lâu hơn vòi I 5 giờ. Gọi x (giờ) là thời gian vòi I chảy một mình đầy bể. Phương trình đúng là:",
          options: ["1/x + 1/(x+5) = 1/6", "1/x − 1/(x+5) = 1/6", "x + (x+5) = 6", "1/x + 1/(x−5) = 6"], answer: 0,
          sol: ["Mỗi giờ vòi I chảy 1/x bể, vòi II chảy 1/(x+5) bể", "Cùng chảy mỗi giờ được 1/6 bể → 1/x + 1/(x+5) = 1/6"] },
        { cau: "Câu 2d", points: 0.5, type: "fill", q: "Giải phương trình ở Câu 2c: vòi I chảy một mình đầy bể trong bao nhiêu giờ?", answer: "10", accept: ["10", "10h", "10 giờ", "10 gio"],
          sol: ["Quy đồng: 6(x+5) + 6x = x(x+5)", "x² − 7x − 30 = 0 → x = 10 (nhận) hoặc x = −3 (loại)", "Thử: 1/10 + 1/15 = 3/30 + 2/30 = 1/6 ✓"] },
        { cau: "Câu 3a", points: 0.5, type: "fill", q: "Cho phương trình x² − 5x + 4 = 0. Tổng hai nghiệm bằng?", answer: "5", accept: ["5"],
          sol: ["Theo Vi-ét: x₁ + x₂ = −b/a = 5"] },
        { cau: "Câu 3b", points: 0.5, type: "fill", q: "Nghiệm lớn hơn của phương trình x² − 5x + 4 = 0 là?", answer: "4", accept: ["4", "x=4"],
          sol: ["a + b + c = 1 − 5 + 4 = 0 → x₁ = 1, x₂ = c/a = 4", "Nghiệm lớn hơn là 4"] },
        { cau: "Câu 3c", points: 0.75, type: "mc", q: "Cho x² − 2(m−1)x + m² − 3 = 0. Điều kiện của m để phương trình có nghiệm là:",
          options: ["m ≤ 2", "m ≥ 2", "m ≤ −2", "mọi m"], answer: 0,
          sol: ["Δ' = (m−1)² − (m² − 3) = m² − 2m + 1 − m² + 3 = −2m + 4", "Có nghiệm ⇔ Δ' ≥ 0 ⇔ −2m + 4 ≥ 0 ⇔ m ≤ 2"] },
        { cau: "Câu 3d", points: 0.75, type: "fill", q: "Với m = 1, tích hai nghiệm của phương trình ở Câu 3c bằng?", answer: "-2", accept: ["-2", "−2"],
          sol: ["Theo Vi-ét: x₁·x₂ = c/a = m² − 3", "m = 1 → tích = 1 − 3 = −2"] },
        { cau: "Câu 4a", points: 1, type: "mc", q: "Tam giác ABC nhọn, hai đường cao BE và CF cắt nhau tại H. Tứ giác AEHF nội tiếp vì:",
          options: ["∠AEH + ∠AFH = 90° + 90° = 180°", "AE = AF", "∠EAF = 90°", "EH = FH"], answer: 0,
          sol: ["BE ⊥ AC → ∠AEH = 90°; CF ⊥ AB → ∠AFH = 90°", "Tổng hai góc đối = 180° → AEHF nội tiếp"] },
        { cau: "Câu 4b", points: 1, type: "mc", q: "Cũng hình trên, tứ giác BFEC nội tiếp trong đường tròn có đường kính là:",
          options: ["BC", "BE", "CF", "AH"], answer: 0,
          sol: ["∠BFC = ∠BEC = 90° (góc nhìn BC dưới góc vuông)", "F, E cùng nhìn BC dưới góc 90° → BFEC nội tiếp đường tròn đường kính BC"] },
        { cau: "Câu 4c", points: 0.5, type: "fill", q: "Nếu BC = 10 cm thì bán kính đường tròn đi qua B, F, E, C bằng? (cm)", answer: "5", accept: ["5", "5cm", "5 cm"],
          sol: ["Đường kính là BC = 10 → bán kính = 10 : 2 = 5 cm"] },
        { cau: "Câu 5", points: 0.5, type: "fill", q: "Giá trị nhỏ nhất của P = x² − 4x + 7 là?", answer: "3", accept: ["3"],
          sol: ["P = (x² − 4x + 4) + 3 = (x − 2)² + 3", "(x − 2)² ≥ 0 → P ≥ 3; dấu bằng khi x = 2", "Vậy min P = 3"] }
      ] },
    { id: "de-2", name: "Đề số 2", desc: "Căn thức → hệ PT & chuyển động → parabol cắt đường thẳng → tiếp tuyến → GTNN",
      questions: [
        { cau: "Câu 1a", points: 1, type: "mc", q: "Rút gọn A = √27 + √12 − √75.",
          options: ["A = 0", "A = √3", "A = 10√3", "A = −√3"], answer: 0,
          sol: ["√27 = 3√3; √12 = 2√3; √75 = 5√3", "A = 3√3 + 2√3 − 5√3 = 0"] },
        { cau: "Câu 1b", points: 1, type: "fill", q: "Tính B = (√7 − √3)(√7 + √3). B = ?", answer: "4", accept: ["4"],
          sol: ["Hằng đẳng thức: (a − b)(a + b) = a² − b²", "B = 7 − 3 = 4"] },
        { cau: "Câu 2a", points: 0.5, type: "fill", q: "Giải hệ: x + y = 5 và 2x − y = 1. Giá trị x = ?", answer: "2", accept: ["2", "x=2"],
          sol: ["Cộng hai phương trình: 3x = 6 → x = 2"] },
        { cau: "Câu 2b", points: 0.5, type: "fill", q: "Với hệ ở Câu 2a, giá trị y = ?", answer: "3", accept: ["3", "y=3"],
          sol: ["x = 2 → 2 + y = 5 → y = 3", "Thử: 2·2 − 3 = 1 ✓"] },
        { cau: "Câu 2c", points: 0.75, type: "mc", q: "Ô tô đi quãng đường 120 km. Lúc về đi nhanh hơn lúc đi 10 km/h nên thời gian về ít hơn 24 phút. Gọi x (km/h) là vận tốc lúc đi. Phương trình đúng là:",
          options: ["120/x − 120/(x+10) = 2/5", "120/(x+10) − 120/x = 2/5", "120/x − 120/(x−10) = 24", "120/x + 120/(x+10) = 2/5"], answer: 0,
          sol: ["24 phút = 24/60 = 2/5 giờ", "Thời gian đi 120/x, thời gian về 120/(x+10)", "Đi lâu hơn về 2/5 giờ → 120/x − 120/(x+10) = 2/5"] },
        { cau: "Câu 2d", points: 0.75, type: "fill", q: "Giải phương trình ở Câu 2c: vận tốc lúc đi bằng bao nhiêu km/h?", answer: "50", accept: ["50", "50km/h", "50 km/h"],
          sol: ["120·10 / [x(x+10)] = 2/5 → x(x+10) = 3000", "x² + 10x − 3000 = 0; Δ = 100 + 12000 = 12100 = 110²", "x = (−10 + 110)/2 = 50 (nhận); nghiệm âm loại"] },
        { cau: "Câu 3a", points: 0.5, type: "fill", q: "Cho x² + x − 6 = 0. Tích hai nghiệm bằng?", answer: "-6", accept: ["-6", "−6"],
          sol: ["Theo Vi-ét: x₁·x₂ = c/a = −6"] },
        { cau: "Câu 3b", points: 0.5, type: "fill", q: "Nghiệm dương của x² + x − 6 = 0 là?", answer: "2", accept: ["2", "x=2"],
          sol: ["x² + x − 6 = (x − 2)(x + 3) = 0", "x = 2 hoặc x = −3 → nghiệm dương là 2"] },
        { cau: "Câu 3c", points: 0.75, type: "mc", q: "Parabol (P): y = x² và đường thẳng (d): y = 2x + 3 có bao nhiêu điểm chung?",
          options: ["2", "1", "0", "3"], answer: 0,
          sol: ["Xét x² = 2x + 3 → x² − 2x − 3 = 0", "Δ' = 1 + 3 = 4 > 0 → hai nghiệm phân biệt → 2 điểm chung"] },
        { cau: "Câu 3d", points: 0.75, type: "fill", q: "Hoành độ giao điểm dương của (P) và (d) ở Câu 3c là?", answer: "3", accept: ["3", "x=3"],
          sol: ["x² − 2x − 3 = 0 có a − b + c = 0 → x = −1 hoặc x = 3", "Hoành độ dương là 3"] },
        { cau: "Câu 4a", points: 1, type: "mc", q: "Từ A ngoài đường tròn (O), kẻ hai tiếp tuyến AB, AC (B, C là tiếp điểm). Tứ giác ABOC nội tiếp vì:",
          options: ["∠ABO + ∠ACO = 90° + 90° = 180°", "AB = AC", "∠BAC = ∠BOC", "OB = OC"], answer: 0,
          sol: ["Tiếp tuyến vuông góc bán kính tại tiếp điểm: ∠ABO = ∠ACO = 90°", "Tổng hai góc đối bằng 180° → ABOC nội tiếp"] },
        { cau: "Câu 4b", points: 1, type: "mc", q: "Cũng hình trên, đường thẳng OA có tính chất nào?",
          options: ["OA là trung trực của BC", "OA song song BC", "OA = BC", "OA là tiếp tuyến của (O)"], answer: 0,
          sol: ["AB = AC (t/c hai tiếp tuyến cắt nhau) và OB = OC = R", "A và O cùng cách đều B, C → OA là trung trực của BC (nên OA ⊥ BC)"] },
        { cau: "Câu 4c", points: 0.5, type: "fill", q: "Nếu OA = 2R thì góc ∠BAC bằng bao nhiêu độ?", answer: "60", accept: ["60", "60°", "60 do", "60 độ"],
          sol: ["sin∠BAO = OB/OA = R/(2R) = 1/2 → ∠BAO = 30°", "AO là phân giác ∠BAC → ∠BAC = 2·30° = 60°"] },
        { cau: "Câu 5", points: 0.5, type: "fill", q: "Giá trị nhỏ nhất của M = x² + 2x + 5 là?", answer: "4", accept: ["4"],
          sol: ["M = (x + 1)² + 4 ≥ 4", "Dấu bằng khi x = −1 → min M = 4"] }
      ] },
    { id: "de-3", name: "Đề số 3", desc: "Căn thức → hệ PT & năng suất → nghiệm đặc biệt → nửa đường tròn → GTLN",
      questions: [
        { cau: "Câu 1a", points: 1, type: "mc", q: "Rút gọn A = √((3 − √5)²).",
          options: ["A = 3 − √5", "A = √5 − 3", "A = 3 + √5", "A = ±(3 − √5)"], answer: 0,
          sol: ["√(x²) = |x|", "Vì √5 ≈ 2,24 < 3 nên 3 − √5 > 0 → A = 3 − √5"] },
        { cau: "Câu 1b", points: 1, type: "fill", q: "Tính B = √16 · √25. B = ?", answer: "20", accept: ["20"],
          sol: ["√16 = 4; √25 = 5", "B = 4 · 5 = 20"] },
        { cau: "Câu 2a", points: 0.5, type: "fill", q: "Giải hệ: 3x + y = 10 và x + y = 4. Giá trị x = ?", answer: "3", accept: ["3", "x=3"],
          sol: ["Trừ vế: (3x + y) − (x + y) = 10 − 4 → 2x = 6 → x = 3"] },
        { cau: "Câu 2b", points: 0.5, type: "fill", q: "Với hệ ở Câu 2a, giá trị y = ?", answer: "1", accept: ["1", "y=1"],
          sol: ["x = 3 → 3 + y = 4 → y = 1"] },
        { cau: "Câu 2c", points: 0.75, type: "mc", q: "Hai tổ cùng làm xong một công việc trong 12 ngày. Tổ II làm một mình lâu hơn tổ I 10 ngày. Gọi x (ngày) là thời gian tổ I làm một mình xong việc. Phương trình đúng là:",
          options: ["1/x + 1/(x+10) = 1/12", "1/x − 1/(x+10) = 1/12", "x + (x+10) = 12", "1/x + 1/(x−10) = 12"], answer: 0,
          sol: ["Mỗi ngày tổ I làm 1/x việc, tổ II làm 1/(x+10) việc", "Cả hai mỗi ngày làm 1/12 việc → 1/x + 1/(x+10) = 1/12"] },
        { cau: "Câu 2d", points: 0.75, type: "fill", q: "Giải phương trình ở Câu 2c: tổ I làm một mình xong việc trong bao nhiêu ngày?", answer: "20", accept: ["20", "20 ngày", "20 ngay"],
          sol: ["12(x+10) + 12x = x(x+10)", "x² − 14x − 120 = 0; Δ = 196 + 480 = 676 = 26²", "x = (14 + 26)/2 = 20 (nhận)", "Thử: 1/20 + 1/30 = 3/60 + 2/60 = 1/12 ✓"] },
        { cau: "Câu 3a", points: 0.5, type: "fill", q: "Cho 2x² − 5x + 2 = 0. Nghiệm lớn hơn là?", answer: "2", accept: ["2", "x=2"],
          sol: ["Δ = 25 − 16 = 9 → √Δ = 3", "x = (5 ± 3)/4 → x = 2 hoặc x = 1/2 → nghiệm lớn là 2"] },
        { cau: "Câu 3b", points: 0.5, type: "mc", q: "Nghiệm còn lại của phương trình ở Câu 3a là:",
          options: ["1/2", "−1/2", "1/4", "5/2"], answer: 0,
          sol: ["Theo Vi-ét: x₁·x₂ = c/a = 2/2 = 1", "x₁ = 2 → x₂ = 1 : 2 = 1/2"] },
        { cau: "Câu 3c", points: 0.75, type: "mc", q: "Cho x² − mx + m − 1 = 0. Khẳng định đúng với mọi m là:",
          options: ["Phương trình luôn có nghiệm x = 1", "Phương trình vô nghiệm khi m > 2", "Phương trình luôn có nghiệm x = −1", "Tổng hai nghiệm bằng m − 1"], answer: 0,
          sol: ["a + b + c = 1 − m + (m − 1) = 0", "→ phương trình luôn có nghiệm x = 1, nghiệm kia x = c/a = m − 1"] },
        { cau: "Câu 3d", points: 0.75, type: "fill", q: "Với m = 4, nghiệm còn lại (khác 1) của phương trình ở Câu 3c là?", answer: "3", accept: ["3", "x=3"],
          sol: ["Nghiệm kia = m − 1", "m = 4 → nghiệm còn lại = 3"] },
        { cau: "Câu 4a", points: 1, type: "mc", q: "M nằm trên nửa đường tròn đường kính AB (M khác A, B). Góc ∠AMB bằng:",
          options: ["90°", "60°", "45°", "180°"], answer: 0,
          sol: ["Góc nội tiếp chắn nửa đường tròn là góc vuông", "→ ∠AMB = 90°"] },
        { cau: "Câu 4b", points: 1, type: "mc", q: "Kẻ MH ⊥ AB tại H. Hệ thức đúng là:",
          options: ["MH² = HA · HB", "MH = HA + HB", "MH² = HA² + HB²", "MH = AB/2"], answer: 0,
          sol: ["Tam giác AMB vuông tại M có MH là đường cao", "Hệ thức lượng: MH² = HA · HB"] },
        { cau: "Câu 4c", points: 0.5, type: "fill", q: "Nếu HA = 2 cm, HB = 8 cm thì MH bằng? (cm)", answer: "4", accept: ["4", "4cm", "4 cm"],
          sol: ["MH² = HA · HB = 2 · 8 = 16", "MH = √16 = 4 cm"] },
        { cau: "Câu 5", points: 0.5, type: "fill", q: "Giá trị lớn nhất của N = −x² + 6x − 5 là?", answer: "4", accept: ["4"],
          sol: ["N = −(x² − 6x + 9) + 4 = −(x − 3)² + 4", "−(x − 3)² ≤ 0 → N ≤ 4; dấu bằng khi x = 3", "Vậy max N = 4"] }
      ] }
  ];


  /* ===== Bộ sinh số ngẫu nhiên cho đề thi (mỗi lần thi số liệu khác nhau) ===== */
  function _ri(a, b) { return a + Math.floor(Math.random() * (b - a + 1)); }
  function _pick(arr) { return arr[Math.floor(Math.random() * arr.length)]; }
  const EXAM_GEN = {
    // Rút gọn k1√a ± k2√a ± k3√a về dạng n√a
    rutGonCan: function () {
      const base = _pick([2, 3, 5]);
      const t = { 2: [[50, 5], [18, 3], [8, 2], [32, 4], [72, 6]], 3: [[27, 3], [12, 2], [75, 5], [48, 4], [108, 6]], 5: [[45, 3], [20, 2], [125, 5], [80, 4]] }[base];
      const sh = t.slice().sort(() => Math.random() - 0.5).slice(0, 3);
      const val = sh[0][1] - sh[1][1] + sh[2][1];
      const ansTxt = val === 0 ? "A = 0" : "A = " + (val === 1 ? "" : val) + "√" + base;
      const wrongs = [val + 2, val - 2, val + sh[1][1] * 2].filter(v => v !== val)
        .map(v => v === 0 ? "A = 0" : "A = " + (v === 1 ? "" : v) + "√" + base);
      return {
        q: "Rút gọn A = √" + sh[0][0] + " − √" + sh[1][0] + " + √" + sh[2][0] + ".",
        options: [ansTxt].concat(wrongs.slice(0, 3)), answer: 0,
        sol: ["√" + sh[0][0] + " = " + sh[0][1] + "√" + base + "; √" + sh[1][0] + " = " + sh[1][1] + "√" + base + "; √" + sh[2][0] + " = " + sh[2][1] + "√" + base,
              "A = (" + sh[0][1] + " − " + sh[1][1] + " + " + sh[2][1] + ")√" + base + " = " + ansTxt.replace("A = ", "")]
      };
    },
    // Hệ 2 ẩn nghiệm nguyên: trả về ẩn x hoặc y
    heHai: function (which) {
      const x = _ri(1, 6), y = _ri(1, 6);
      const a1 = _ri(1, 3), b1 = 1, c1 = a1 * x + y;
      const a2 = 1, b2 = -1, c2 = x - y;
      return {
        q: "Giải hệ: " + (a1 === 1 ? "" : a1) + "x + y = " + c1 + " và x − y = " + (c2 < 0 ? "−" + Math.abs(c2) : c2) + ". Giá trị " + which + " = ?",
        answer: String(which === "x" ? x : y), accept: [String(which === "x" ? x : y), which + "=" + (which === "x" ? x : y)],
        sol: ["Cộng vế với vế: " + (a1 + 1) + "x = " + (c1 + c2) + " → x = " + x,
              "Thay vào x − y = " + c2 + " → y = " + y,
              "Thử lại: " + (a1 === 1 ? "" : a1 + "·") + x + " + " + y + " = " + c1 + " ✓"]
      };
    },
    // Vi-ét: x² − Sx + P = 0 với nghiệm nguyên đẹp
    vietTongTich: function (mode) {
      const r1 = _ri(1, 5), r2 = _ri(r1 + 1, 9);
      const S2 = r1 + r2, P = r1 * r2;
      const q = "Cho phương trình x² − " + S2 + "x + " + P + " = 0. ";
      if (mode === "tong") return { q: q + "Tổng hai nghiệm bằng?", answer: String(S2), accept: [String(S2)], sol: ["Theo Vi-ét: x₁ + x₂ = −b/a = " + S2] };
      if (mode === "tich") return { q: q + "Tích hai nghiệm bằng?", answer: String(P), accept: [String(P)], sol: ["Theo Vi-ét: x₁·x₂ = c/a = " + P] };
      return { q: q + "Nghiệm lớn hơn là?", answer: String(r2), accept: [String(r2), "x=" + r2],
        sol: ["Nhẩm hai số có tổng " + S2 + " và tích " + P + ": đó là " + r1 + " và " + r2, "Nghiệm lớn hơn là " + r2] };
    },
    // GTNN của x² + bx + c dạng (x+m)² + k
    gtnn: function () {
      const m = _ri(1, 5), k = _ri(1, 6);
      const b = 2 * m, c = m * m + k;
      return { q: "Giá trị nhỏ nhất của P = x² + " + b + "x + " + c + " là?", answer: String(k), accept: [String(k)],
        sol: ["P = (x² + " + b + "x + " + m * m + ") + " + k + " = (x + " + m + ")² + " + k,
              "(x + " + m + ")² ≥ 0 → P ≥ " + k + "; dấu bằng khi x = −" + m, "Vậy min P = " + k] };
    },
    // Hệ thức lượng: MH² = HA·HB với tích chính phương
    duongCao: function () {
      const h = _pick([4, 6, 8, 10, 12]);
      const pairs = []; for (let a = 1; a <= h * h; a++) if (h * h % a === 0 && a < h * h / a) pairs.push([a, h * h / a]);
      const p = _pick(pairs.filter(x => x[0] >= 2)) || [2, h * h / 2];
      return { q: "Tam giác AMB vuông tại M, đường cao MH. Nếu HA = " + p[0] + " cm, HB = " + p[1] + " cm thì MH bằng? (cm)",
        answer: String(h), accept: [String(h), h + "cm", h + " cm"],
        sol: ["Hệ thức lượng trong tam giác vuông: MH² = HA · HB", "MH² = " + p[0] + " · " + p[1] + " = " + h * h, "MH = √" + h * h + " = " + h + " cm"] };
    }
  };

  /* ===== Đề 4 & 5 ===== */
  const EXAMS_EXTRA = [
    { id: "de-4", name: "Đề số 4", desc: "Số liệu ngẫu nhiên mỗi lần thi — căn thức → hệ PT & tỉ lệ → Vi-ét → góc nội tiếp → GTNN",
      questions: [
        { cau: "Câu 1a", points: 1, type: "mc", gen: "rutGonCan" },
        { cau: "Câu 1b", points: 1, type: "fill", q: "Tính B = √8 · √2 + √9. B = ?", answer: "7", accept: ["7"],
          sol: ["√8 · √2 = √16 = 4", "√9 = 3 → B = 4 + 3 = 7"] },
        { cau: "Câu 2a", points: 0.75, type: "fill", gen: "heHai", genArg: "x" },
        { cau: "Câu 2b", points: 0.75, type: "fill", gen: "heHai", genArg: "y" },
        { cau: "Câu 2c", points: 0.5, type: "mc", q: "Một mảnh vườn hình chữ nhật có chu vi 40 m, chiều dài hơn chiều rộng 6 m. Gọi x, y (m) là dài và rộng. Hệ phương trình đúng là:",
          options: ["x + y = 20 và x − y = 6", "x + y = 40 và x − y = 6", "2x + 2y = 20 và x − y = 6", "x·y = 40 và x − y = 6"], answer: 0,
          sol: ["Chu vi 40 → nửa chu vi x + y = 20", "Dài hơn rộng 6 → x − y = 6"] },
        { cau: "Câu 2d", points: 0.5, type: "fill", q: "Với Câu 2c, diện tích mảnh vườn bằng bao nhiêu m²?", answer: "91", accept: ["91"],
          sol: ["x + y = 20, x − y = 6 → x = 13, y = 7", "Diện tích = 13 · 7 = 91 m²"] },
        { cau: "Câu 3a", points: 0.5, type: "fill", gen: "vietTongTich", genArg: "tong" },
        { cau: "Câu 3b", points: 0.5, type: "fill", gen: "vietTongTich", genArg: "lon" },
        { cau: "Câu 3c", points: 0.75, type: "mc", q: "Phương trình x² − 2x + m = 0 có hai nghiệm phân biệt khi:",
          options: ["m < 1", "m > 1", "m ≤ 1", "m = 1"], answer: 0,
          sol: ["Δ' = 1 − m", "Hai nghiệm phân biệt ⇔ Δ' > 0 ⇔ 1 − m > 0 ⇔ m < 1"] },
        { cau: "Câu 3d", points: 0.75, type: "fill", q: "Với m = −3, tổng hai nghiệm của x² − 2x + m = 0 bằng?", answer: "2", accept: ["2"],
          sol: ["Theo Vi-ét: x₁ + x₂ = −b/a = 2 (không phụ thuộc m)"] },
        { cau: "Câu 4a", points: 1, type: "mc", q: "Trên đường tròn (O), góc nội tiếp ∠ACB chắn cung AB có số đo 80°. Số đo ∠ACB bằng:",
          options: ["40°", "80°", "160°", "20°"], answer: 0,
          sol: ["Góc nội tiếp bằng nửa số đo cung bị chắn", "∠ACB = 80° : 2 = 40°"] },
        { cau: "Câu 4b", points: 1, type: "mc", q: "Hai góc nội tiếp cùng chắn một cung của đường tròn thì:",
          options: ["bằng nhau", "bù nhau", "phụ nhau", "gấp đôi nhau"], answer: 0,
          sol: ["Mỗi góc đều bằng nửa số đo cung bị chắn", "→ hai góc bằng nhau"] },
        { cau: "Câu 4c", points: 0.5, type: "fill", q: "Tứ giác ABCD nội tiếp có ∠A = 70°. Số đo ∠C bằng bao nhiêu độ?", answer: "110", accept: ["110", "110°"],
          sol: ["Tứ giác nội tiếp: hai góc đối bù nhau", "∠C = 180° − 70° = 110°"] },
        { cau: "Câu 5", points: 0.5, type: "fill", gen: "gtnn" }
      ] },
    { id: "de-5", name: "Đề số 5", desc: "Số liệu ngẫu nhiên — căn thức → hệ PT & phần trăm → parabol & Vi-ét → hệ thức lượng → GTNN",
      questions: [
        { cau: "Câu 1a", points: 1, type: "mc", gen: "rutGonCan" },
        { cau: "Câu 1b", points: 1, type: "fill", q: "Tính B = √(4·9) − √4. B = ?", answer: "4", accept: ["4"],
          sol: ["√(4·9) = √36 = 6", "√4 = 2 → B = 6 − 2 = 4"] },
        { cau: "Câu 2a", points: 0.75, type: "fill", gen: "heHai", genArg: "x" },
        { cau: "Câu 2b", points: 0.75, type: "fill", gen: "heHai", genArg: "y" },
        { cau: "Câu 2c", points: 0.5, type: "mc", q: "Một chiếc áo giảm giá 20% còn 320 nghìn đồng. Gọi x (nghìn đồng) là giá gốc. Phương trình đúng là:",
          options: ["0,8x = 320", "1,2x = 320", "x − 20 = 320", "0,2x = 320"], answer: 0,
          sol: ["Giảm 20% → còn lại 80% giá gốc", "0,8x = 320"] },
        { cau: "Câu 2d", points: 0.5, type: "fill", q: "Với Câu 2c, giá gốc chiếc áo là bao nhiêu nghìn đồng?", answer: "400", accept: ["400", "400k"],
          sol: ["0,8x = 320 → x = 320 : 0,8 = 400", "Thử: 400 · 80% = 320 ✓"] },
        { cau: "Câu 3a", points: 0.5, type: "fill", gen: "vietTongTich", genArg: "tich" },
        { cau: "Câu 3b", points: 0.5, type: "fill", gen: "vietTongTich", genArg: "lon" },
        { cau: "Câu 3c", points: 0.75, type: "mc", q: "Điểm A(2; 4) thuộc parabol (P): y = ax². Giá trị của a là:",
          options: ["1", "2", "4", "1/2"], answer: 0,
          sol: ["Thay x = 2, y = 4: 4 = a · 2² = 4a", "→ a = 1"] },
        { cau: "Câu 3d", points: 0.75, type: "fill", q: "Với (P): y = x², tung độ của điểm trên (P) có hoành độ −3 là?", answer: "9", accept: ["9"],
          sol: ["y = (−3)² = 9"] },
        { cau: "Câu 4a", points: 1, type: "mc", q: "Tam giác ABC vuông tại A, AB = 6, AC = 8. Độ dài BC bằng:",
          options: ["10", "12", "14", "48"], answer: 0,
          sol: ["Định lí Pythagore: BC² = 6² + 8² = 36 + 64 = 100", "BC = 10"] },
        { cau: "Câu 4b", points: 1, type: "mc", q: "Cũng tam giác trên, sin B bằng:",
          options: ["4/5", "3/5", "3/4", "5/4"], answer: 0,
          sol: ["sin B = cạnh đối / huyền = AC/BC = 8/10 = 4/5"] },
        { cau: "Câu 4c", points: 0.5, type: "fill", gen: "duongCao" },
        { cau: "Câu 5", points: 0.5, type: "fill", gen: "gtnn" }
      ] }
  ];


  /* ===================== 🔮 GÓC RAMANUJAN — NHÌN RA QUY LUẬT ===================== */
  const RAMA = [
    {
      id: "r-so-le", emoji: "🔢", title: "Tổng các số lẻ giấu một hình vuông",
      story: "Ramanujan hồi nhỏ không có sách, ông chỉ có một quyển công thức và… rất nhiều giấy nháp. Cách học của ông là <b>viết ra thật nhiều trường hợp nhỏ rồi ngồi nhìn</b> cho tới khi quy luật hiện ra. Thử làm y như vậy nhé!",
      observe: [["1", "1"], ["1 + 3", "4"], ["1 + 3 + 5", "9"], ["1 + 3 + 5 + 7", "16"]],
      observeNote: "Nhìn cột kết quả: 1, 4, 9, 16… em thấy gì quen quen không?",
      guess: { q: "Đoán xem: 1 + 3 + 5 + 7 + 9 = ?", answer: "25", accept: ["25"] },
      rule: "Tổng của <b>n số lẻ đầu tiên</b> luôn bằng <b>n²</b>. (1, 4, 9, 16, 25… chính là 1², 2², 3², 4², 5²!)",
      proof: [
        "Xếp 1 viên sỏi, rồi thêm 3 viên bao quanh thành hình vuông 2×2, thêm 5 viên thành 3×3…",
        "Mỗi lần thêm một số lẻ là ta viền thêm một cạnh chữ L để hình vuông lớn thêm 1 đơn vị.",
        "Sau n bước ta có hình vuông n×n → tổng = n²."
      ],
      apply: [
        { type: "fill", q: "Tính nhanh 1 + 3 + 5 + … + 19 (10 số lẻ đầu).", answer: "100", accept: ["100"],
          sol: ["Có đúng 10 số lẻ → tổng = 10² = 100"] },
        { type: "mc", q: "Tổng 1 + 3 + 5 + … + 99 bằng bao nhiêu?", options: ["2500", "5000", "990", "9900"], answer: 0,
          sol: ["Số lẻ từ 1 đến 99 có (99+1)/2 = 50 số", "Tổng = 50² = 2500"] }
      ]
    },
    {
      id: "r-tan-cung-5", emoji: "⚡", title: "Bình phương số tận cùng bằng 5 — 2 giây",
      story: "Ramanujan tính nhẩm nhanh tới mức bạn học tưởng ông có phép thuật. Bí mật: ông không tính, ông <b>nhớ quy luật</b>. Đây là một quy luật như thế.",
      observe: [["15²", "225"], ["25²", "625"], ["35²", "1225"], ["45²", "2025"]],
      observeNote: "Mọi kết quả đều kết thúc bằng <b>25</b>. Còn phần đầu: 2, 6, 12, 20 — so với 1, 2, 3, 4 thì sao?",
      guess: { q: "Đoán: 55² = ? (gợi ý: phần đầu lấy 5 × 6)", answer: "3025", accept: ["3025"] },
      rule: "Với số dạng <b>a5</b>: lấy <b>a × (a+1)</b> rồi viết thêm <b>25</b> vào sau. Ví dụ 85² → 8×9 = 72 → <b>7225</b>.",
      proof: [
        "Số đó là 10a + 5.",
        "(10a + 5)² = 100a² + 100a + 25 = 100·a(a+1) + 25.",
        "100·a(a+1) nghĩa là viết a(a+1) rồi thêm hai chữ số 25 phía sau."
      ],
      apply: [
        { type: "fill", q: "Tính nhẩm 65².", answer: "4225", accept: ["4225"], sol: ["6 × 7 = 42 → viết thêm 25 → 4225"] },
        { type: "fill", q: "Tính nhẩm 95².", answer: "9025", accept: ["9025"], sol: ["9 × 10 = 90 → thêm 25 → 9025"] }
      ]
    },
    {
      id: "r-hieu-binh-phuong", emoji: "🎯", title: "Hiệu hai bình phương — mẹo phá số to",
      story: "Khi gặp con số khổng lồ, Ramanujan không nhân trực tiếp mà tìm cách <b>tách nó thành thứ dễ hơn</b>. Đây là mẹo tách quyền lực nhất.",
      observe: [["11² − 9²", "40 = 2 × 20"], ["21² − 19²", "80 = 2 × 40"], ["51² − 49²", "200 = 2 × 100"], ["101² − 99²", "400 = 2 × 200"]],
      observeNote: "Trong mỗi dòng: 2 là <b>hiệu</b> hai số, còn 20, 40, 100, 200 là gì của chúng?",
      guess: { q: "Đoán: 31² − 29² = ?", answer: "120", accept: ["120"] },
      rule: "<b>a² − b² = (a − b)(a + b)</b>. Hiệu hai bình phương biến thành một phép nhân dễ hơn nhiều!",
      proof: [
        "Khai triển (a − b)(a + b) = a² + ab − ab − b² = a² − b².",
        "Vậy đẳng thức đúng với mọi a, b — không cần thử từng trường hợp."
      ],
      apply: [
        { type: "fill", q: "Tính nhanh 2026² − 2024².", answer: "8100", accept: ["8100"],
          sol: ["= (2026 − 2024)(2026 + 2024) = 2 × 4050 = 8100"] },
        { type: "mc", q: "Tính nhanh 98 × 102.", options: ["9996", "9998", "10000", "9990"], answer: 0,
          sol: ["98 × 102 = (100 − 2)(100 + 2) = 100² − 2² = 10000 − 4 = 9996"] }
      ]
    },
    {
      id: "r-nham-nghiem", emoji: "🥷", title: "Đọc nghiệm phương trình bậc hai không cần Δ",
      story: "Ramanujan hay viết thẳng đáp số mà không ghi lời giải, khiến Hardy phát điên. Ông \"nhìn\" ra nghiệm nhờ các quy luật đặc biệt. Đây là hai quy luật em dùng được ngay trong đề thi vào 10.",
      observe: [["x² − 5x + 4 = 0", "1 − 5 + 4 = 0 → x = 1 và 4"], ["2x² − 7x + 5 = 0", "2 − 7 + 5 = 0 → x = 1 và 5/2"], ["x² + 3x + 2 = 0", "1 − 3 + 2 = 0 → x = −1 và −2"], ["3x² + 8x + 5 = 0", "3 − 8 + 5 = 0 → x = −1 và −5/3"]],
      observeNote: "Hai dòng đầu: <b>a + b + c = 0</b>. Hai dòng sau: <b>a − b + c = 0</b>. Nghiệm đầu tiên khác nhau chỗ nào?",
      guess: { q: "Phương trình x² − 9x + 8 = 0 có a + b + c = 1 − 9 + 8 = 0. Nghiệm nhỏ hơn là?", answer: "1", accept: ["1", "x=1"] },
      rule: "Nếu <b>a + b + c = 0</b> → x₁ = 1, x₂ = c/a. Nếu <b>a − b + c = 0</b> → x₁ = −1, x₂ = −c/a. Nhìn 2 giây là ra, không cần Δ!",
      proof: [
        "Thay x = 1 vào ax² + bx + c được a + b + c. Nếu tổng này = 0 thì x = 1 đúng là nghiệm.",
        "Theo Vi-ét, tích hai nghiệm = c/a; đã có x₁ = 1 nên x₂ = c/a.",
        "Tương tự, thay x = −1 được a − b + c → nếu bằng 0 thì x = −1 là nghiệm, và x₂ = −c/a."
      ],
      apply: [
        { type: "fill", q: "Nghiệm còn lại của 5x² − 8x + 3 = 0 (biết 5 − 8 + 3 = 0) là? (viết dạng phân số a/b)", answer: "3/5", accept: ["3/5", "0.6", "0,6"],
          sol: ["a + b + c = 0 → x₁ = 1", "x₂ = c/a = 3/5"] },
        { type: "mc", q: "Phương trình 4x² + 9x + 5 = 0 có một nghiệm là:", options: ["−1", "1", "5", "−5"], answer: 0,
          sol: ["a − b + c = 4 − 9 + 5 = 0 → x = −1 là nghiệm", "Nghiệm kia là −c/a = −5/4"] }
      ]
    },
    {
      id: "r-can-long", emoji: "🌀", title: "Căn lồng vô tận của chính Ramanujan",
      story: "Năm 1911, Ramanujan đăng một câu đố lên tạp chí Toán Ấn Độ: tính giá trị của <b>√(1 + 2√(1 + 3√(1 + 4√(…))))</b>. Sáu tháng không ai giải được. Ông tự công bố đáp án — và nó đẹp đến khó tin.",
      observe: [["√(1 + 2·3)", "√7 ≈ 2,646"], ["√(1 + 2√(1 + 3·4))", "√(1+2·√13) ≈ 2,935"], ["thêm 1 tầng nữa", "≈ 2,9908"], ["thêm 1 tầng nữa", "≈ 2,99926"]],
      observeNote: "Dãy số đang tiến rất nhanh về một số nguyên. Số nào?",
      guess: { q: "Đoán giá trị của căn lồng vô tận đó (một số nguyên).", answer: "3", accept: ["3"] },
      rule: "Đáp án là <b>3</b>. Chìa khoá của Ramanujan: viết <b>n + 2 = √(1 + (n+1)(n+3))</b> rồi lồng mãi vào nhau.",
      proof: [
        "Để ý hằng đẳng thức: (n+1)(n+3) + 1 = n² + 4n + 4 = (n+2)².",
        "Suy ra n + 2 = √(1 + (n+1)(n+3)) — thay (n+3) bằng chính công thức đó lần nữa, ta được căn lồng thêm một tầng.",
        "Cho n = 1: 3 = √(1 + 2·4) = √(1 + 2√(1 + 3·5)) = √(1 + 2√(1 + 3√(1 + 4·6))) = … → căn lồng vô tận bằng 3."
      ],
      apply: [
        { type: "fill", q: "Dùng hằng đẳng thức trên với n = 2: giá trị của √(1 + 3·5) là?", answer: "4", accept: ["4"],
          sol: ["1 + 3·5 = 16", "√16 = 4 (đúng bằng n + 2 = 4)"] },
        { type: "mc", q: "Vì sao (n+1)(n+3) + 1 luôn là số chính phương?", options: ["Vì nó bằng (n+2)²", "Vì n luôn chẵn", "Vì tích hai số lẻ", "Đó chỉ là trùng hợp"], answer: 0,
          sol: ["(n+1)(n+3) = n² + 4n + 3", "Cộng 1 được n² + 4n + 4 = (n+2)² — luôn chính phương"] }
      ]
    },
    {
      id: "r-can-kep", emoji: "🎁", title: "Mở gói căn trong căn: √(7 + 4√3)",
      story: "Ramanujan có biệt tài <b>nhìn một biểu thức xấu và thấy nó vốn là thứ đẹp bị gói lại</b>. Căn trong căn là ví dụ kinh điển.",
      observe: [["(1 + √2)²", "3 + 2√2"], ["(2 + √3)²", "7 + 4√3"], ["(1 + √3)²", "4 + 2√3"], ["(2 + √5)²", "9 + 4√5"]],
      observeNote: "Cột phải trông rất \"xấu\", nhưng cột trái cho thấy chúng đều là bình phương của thứ gọn gàng. Vậy √(7 + 4√3) = ?",
      guess: { q: "Rút gọn √(7 + 4√3). (viết dạng: 2+√3)", answer: "2+√3", accept: ["2+√3", "2 + √3", "2+can3", "2+√3 ", "√3+2"] },
      rule: "Nếu đưa được biểu thức về dạng <b>m² + n² + 2mn = (m + n)²</b> thì <b>√(m² + n² + 2mn) = m + n</b>. Mẹo: tách số ở giữa thành 2mn.",
      proof: [
        "Viết 7 + 4√3 = 4 + 3 + 2·2·√3 = 2² + (√3)² + 2·2·√3.",
        "Đó đúng là dạng (m + n)² với m = 2, n = √3.",
        "Vậy √(7 + 4√3) = 2 + √3 (nhận vì 2 + √3 > 0)."
      ],
      apply: [
        { type: "mc", q: "Rút gọn √(3 + 2√2).", options: ["1 + √2", "2 + √2", "√3 + √2", "3 − √2"], answer: 0,
          sol: ["3 + 2√2 = 1 + 2 + 2·1·√2 = (1 + √2)²", "Vậy căn bằng 1 + √2"] },
        { type: "mc", q: "Rút gọn √(9 + 4√5).", options: ["2 + √5", "4 + √5", "3 + √5", "1 + 2√5"], answer: 0,
          sol: ["9 + 4√5 = 4 + 5 + 2·2·√5 = (2 + √5)²", "Vậy căn bằng 2 + √5"] }
      ]
    },
    {
      id: "r-bon-so", emoji: "✨", title: "Bốn số liên tiếp và một điều bất ngờ",
      story: "Ramanujan tin rằng <b>mỗi số nguyên đều là bạn của ông</b>. Ông thích thử nghịch với những dãy số bình thường để xem chúng giấu gì bên trong. Thử nghịch giống ông nhé.",
      observe: [["1·2·3·4 + 1", "25 = 5²"], ["2·3·4·5 + 1", "121 = 11²"], ["3·4·5·6 + 1", "361 = 19²"], ["4·5·6·7 + 1", "841 = 29²"]],
      observeNote: "Lần nào cũng ra số chính phương! Các căn 5, 11, 19, 29 tăng theo quy luật nào?",
      guess: { q: "Đoán: 5·6·7·8 + 1 là bình phương của số nào?", answer: "41", accept: ["41"] },
      rule: "<b>Tích 4 số nguyên liên tiếp cộng 1 luôn là số chính phương</b>: n(n+1)(n+2)(n+3) + 1 = <b>(n² + 3n + 1)²</b>.",
      proof: [
        "Ghép khéo: [n(n+3)]·[(n+1)(n+2)] = (n² + 3n)(n² + 3n + 2).",
        "Đặt t = n² + 3n, biểu thức thành t(t + 2) + 1 = t² + 2t + 1 = (t + 1)².",
        "Thay lại: = (n² + 3n + 1)² — luôn là số chính phương."
      ],
      apply: [
        { type: "fill", q: "Với n = 6: 6·7·8·9 + 1 là bình phương của số nào? (dùng n² + 3n + 1)", answer: "55", accept: ["55"],
          sol: ["n² + 3n + 1 = 36 + 18 + 1 = 55", "Thử: 6·7·8·9 + 1 = 3024 + 1 = 3025 = 55² ✓"] },
        { type: "mc", q: "10·11·12·13 + 1 bằng:", options: ["131²", "130²", "121²", "141²"], answer: 0,
          sol: ["n = 10 → n² + 3n + 1 = 100 + 30 + 1 = 131", "Vậy kết quả là 131²"] }
      ]
    },
    {
      id: "r-1729", emoji: "🚕", title: "1729 — con số taxi nổi tiếng nhất lịch sử",
      story: "Hardy đến thăm Ramanujan trong bệnh viện và than rằng ông đi chiếc taxi số <b>1729</b>, một con số \"nhạt nhẽo\". Ramanujan lập tức đáp: không đâu, đó là <b>số nhỏ nhất viết được thành tổng hai lập phương theo hai cách khác nhau</b>. Ông nhìn ra ngay trên giường bệnh.",
      observe: [["1³ + 12³", "1 + 1728 = 1729"], ["9³ + 10³", "729 + 1000 = 1729"], ["1³ + 5³ (thử số nhỏ)", "126 — chỉ một cách"], ["2³ + 4³ (thử số nhỏ)", "72 — chỉ một cách"]],
      observeNote: "Hai dòng đầu cho cùng một kết quả bằng hai bộ số hoàn toàn khác nhau — điều rất hiếm!",
      guess: { q: "Tính 9³ + 10³ để tự kiểm chứng.", answer: "1729", accept: ["1729"] },
      rule: "1729 = 1³ + 12³ = 9³ + 10³ — nay gọi là <b>số taxicab</b>. Bài học: đừng vội chê một con số (hay một bài toán) là nhạt — hãy thử tách nó ra xem.",
      proof: [
        "12³ = 1728, cộng 1³ = 1 → 1729.",
        "10³ = 1000 và 9³ = 729, cộng lại → 1729.",
        "Kiểm mọi cặp lập phương nhỏ hơn cho thấy không số nào bé hơn 1729 có hai cách viết như vậy."
      ],
      apply: [
        { type: "fill", q: "Tính 1³ + 12³.", answer: "1729", accept: ["1729"], sol: ["1 + 1728 = 1729"] },
        { type: "mc", q: "Phân tích a³ + b³ thành nhân tử được:", options: ["(a + b)(a² − ab + b²)", "(a + b)(a² + ab + b²)", "(a − b)(a² + ab + b²)", "(a + b)³"], answer: 0,
          sol: ["Hằng đẳng thức tổng hai lập phương: a³ + b³ = (a + b)(a² − ab + b²)", "Thử với a = 9, b = 10: 19 × (81 − 90 + 100) = 19 × 91 = 1729 ✓"] }
      ]
    }
  ];
